...
function getMyCrop() {
    setTimeout(function () {
        ...
        if (web3.eth.accounts[0] === undefined) { 
            alertify.error('Not connected to P3C.')
        } else {
...
function activateUI(cropAddress) {
    ...
    $("#masternodeLink").replaceWith('<a id="masternodeLink" href="https://arcadiumnetwork.github.io/Odyssey/?ref=' + myCropAddress + '">Link Active</a>')
